...
import com.example.ing_medor.deuxiemedevoir.ArticleArrayAdapter;
...
public class FirstActivity extends AppCompatActivity {
    ...
    public void onArticleSearch(View view) {
        ...
        params.put("api-key", "c0ffbd2c5040465fb2dbd3c18fe4276f");
        params.put("page", 0);
        params.put("q", query);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.ing_medor.deuxiemedevoir.activities/http/host/path")
        );
